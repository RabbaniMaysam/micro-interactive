...
| 3 | `#shift-equilibrium` | Shifts and the new equilibrium | longer D and S segments (Q from 12 to 95) crossing at e1; two horizontal knobs (Shift D, Shift S, each -35 to 35) draw the shifted curve in blue as D2 or S2, the new crossing e2, P1, P2, Q1, Q2 on the axes with no numbers, and blue arrows hugging each axis from 1 to 2; a "2" label is offset when it would print on the "1" label |
