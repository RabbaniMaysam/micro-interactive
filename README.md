...
| 6 | `#elasticity-slope` | Elasticity and slope | two panels titled Demand and Supply, 340px tall, on the DS frame (Q 0 to 115, P 0 to 100) with arrow axes labeled Q and P; each line is a segment of half-length 42 pivoting about (55, 50); a continuous horizontal knob under the figure (step "any") sets the angle from horizontal (0) to vertical (90), default 45; a continuous vertical knob at the left slides the point along the segment (lower end, middle by default, upper end); the point elasticity E = (dQ/dP)(P/Q) prints beside the point with three decimals and its sign ("E<sub>d</sub> = −0.512"; demand always negative, supply always positive; −∞ or ∞ on a horizontal line, 0.000 on a vertical one); dotted guides read P and Q of the point on the axes, rounded to integers; D or S sits at the right end of the line; the elasticity label is above right (demand) or below right (supply) of the point, switched to the opposite corner when it would leave the frame at the right, print on the line's letter, or sit on the Q axis (added September 10, 2026) |
